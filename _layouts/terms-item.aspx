		...
		<section class="row content-area">
			<div class="row-content">
				<div id="col_01" class="vx_drag vx_blocks_file_blocks-content-area-items col-sm-12 accordion-content">
					...
					<div class="vx_block">
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam dapibus sodales facilisis. Mauris commodo risus nec placerat molestie. Cras consequat, nisi vel posuere porta, eros mauris efficitur sapien, vitae pulvinar velit lectus a tellus. Aenean ac risus felis. Proin dapibus tincidunt odio, laoreet pharetra eros consequat eu. Maecenas id rhoncus tortor, non mattis nulla. Sed in ipsum faucibus, malesuada nunc at, consectetur nibh. Vestibulum non congue ligula.</p>
						<p>Etiam sit amet odio semper risus ultricies pharetra. In sagittis a ex id pellentesque. Suspendisse tempor tortor id dolor tincidunt euismod. Suspendisse viverra nulla eget libero venenatis, ut semper sem sagittis. Nunc in blandit elit. In et velit lorem. Mauris vitae justo semper, volutpat eros nec, posuere mi. Duis in convallis mi. Proin blandit iaculis ipsum id tristique.</p>
						...
						<div id="col_02" class="vx_drag vx_blocks_file_blocks-accordion-content col-sm-12">
							<div class="vx_block accordion-item">
								...
								<div id="col_03" class="vx_drag vx_blocks_file_blocks-accordion-item-info info">
									...
									<div class="vx_block blockquote">
										<div class="vx_text quote">
											<p>Etiam sit amet odio semper risus ultricies pharetra. In sagittis a ex id pellentesque. Suspendisse tempor tortor id dolor tincidunt euismod. Suspendisse viverra nulla eget libero venenatis, ut semper sem sagittis. Nunc in blandit elit. In et velit lorem. Mauris vitae justo semper.</p>
										</div>
										<div class="vx_text cite">
											<p>Referece, name</p>
										</div>
									</div>
								</div>
